package codegym.customer_province_manager.controller;

import codegym.customer_province_manager.model.Category;
import codegym.customer_province_manager.service.CategoryService;
...
public class CategoryController {
    ...
    @GetMapping("/category")
    public ModelAndView listCategory(@PageableDefault(size = 5, sort = "name", direction = Sort.Direction.ASC) Pageable pageable) {
